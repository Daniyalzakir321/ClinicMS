...
namespace Clinic_Management_System
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select DoctorID from Doctor ", o.sqlConnection1);
            ...
            o.sqlConnection1.Open();
           // SqlCommand
            SqlCommand cmd2 = new SqlCommand("select count(PID) from patient", o.sqlConnection1);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                o.sqlConnection1.Open();
                SqlCommand cmd1 = new SqlCommand("Insert into Patient(PID,Name,Age,Gender,CNIC,FatherName,MobileNum,MotherName,Address,CheckupFees,AdmitDate,Disease,DoctorID,DoctorName,WardType,WardNum,RoomNum,BedNum) values (@PID,@Name,@Age,@Gender,@CNIC,@FatherName,@MobileNum,@MotherName,@Address,@CheckupFees,@AdmitDate,@Disease,@DoctorID,@DoctorName,@WardType,@WardNum,@RoomNum,@BedNum)", o.sqlConnection1);
                cmd1.Parameters.AddWithValue("@PID", Username.Text);
                cmd1.Parameters.AddWithValue("@Name", textBox1.Text);
                cmd1.Parameters.AddWithValue("@Age", Convert.ToInt32(textBox2.Text));
                cmd1.Parameters.AddWithValue("@Gender", textBox10.Text);
            

                cmd1.Parameters.AddWithValue("@CNIC", Convert.ToInt32(textBox4.Text));
                cmd1.Parameters.AddWithValue("@FatherName", textBox5.Text);
                cmd1.Parameters.AddWithValue("@MobileNum", Convert.ToInt32(textBox6.Text));
                cmd1.Parameters.AddWithValue("@MotherName", textBox7.Text);
                cmd1.Parameters.AddWithValue("@Address", textBox8.Text);
                cmd1.Parameters.AddWithValue("@CheckupFees", Convert.ToInt32(textBox9.Text));

                cmd1.Parameters.AddWithValue("@AdmitDate", dateTimePicker1.Text);
                ...
                cmd1.Parameters.AddWithValue("@WardNum", Convert.ToInt32(comboBox2.Text));
                cmd1.Parameters.AddWithValue("@RoomNum", Convert.ToInt32(comboBox3.Text));
                cmd1.Parameters.AddWithValue("@BedNum", Convert.ToInt32(comboBox4.Text));
        ...
        private void comboBox5_SelectedIndexChanged(object sender, EventArgs e)
        {
            //Doctor ID in admit patient
            o.sqlConnection1.Open();
            SqlCommand cmddd = new SqlCommand("Select *from Doctor where DoctorID = '" + comboBox5.Text + "'", o.sqlConnection1);
