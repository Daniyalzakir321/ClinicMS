...
namespace Clinic_Management_System
{
    public partial class Form5 : Form
    {
        ...
        { this.textBox9.Text = "Female"; }
           ...
           SqlCommand cmd2 = new SqlCommand("select count(SID) from Staff", o.sqlConnection1);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                o.sqlConnection1.Open();
               SqlCommand cmd = new SqlCommand ("Insert into Staff(SID,SName,StaffType,Gender,DOB,Address,City,MobileNum,EmailID,Experience ) values (@SID,@SName,@StaffType,@Gender,@DOB,@Address,@City,@MobileNum,@EmailID,@Experience)", o.sqlConnection1);
                ...
                cmd.Parameters.AddWithValue("@MobileNum", Convert.ToInt32(textBox6.Text));
